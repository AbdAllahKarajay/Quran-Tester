                  ...
                  SizedBox(
                    ...
                    child: Stack(
                      children: [
                        ...
                        Center(child: Text(TestPage.name, style: TextStyle(fontSize: 18),),)
                      ],
                    ),
                  ),
                  const Divider(
                                      ...
                                      children: List.generate(
                                        ...
                                        return Row(
                                          children: [
                                            ...
                                            Expanded(child: SizedBox(height: 50,child: Align(alignment: Alignment.centerRight,child: Text(TestPage.notes[index-1])))),
                                          ],
                                        );
                                      }).toList(),
                                    ),
                                    ...
                                    children: List.generate(
                                      ...
                                      return Row(
                                        children: [
                                          ...
                                          Expanded(
                                              child: SizedBox(height: 50,child: Align(alignment: Alignment.centerRight,child: Text(TestPage.notes[index-2])))),
                                          const SizedBox(
                                            width: 10,
                                          ),
                                          IconButton(
                                                ...
                                                children: [
                                                  ...
                                                  SizedBox(
                                                      ...
                                                      child: IconButton(
                                                        onPressed: () =>
                                                            setState(() {
                                                          if (TestPage.faults[index ~/ 2-1][4] > 0) {
                                                            TestPage.mark += taj;
                                    ...
                                    if(!widget.isResult)
                                      IconButton(
                                        onPressed: () {
                                          ...
                                          questionCount--;
                                          TestPage.questions.removeAt(index ~/ 2 - 1);
                                          TestPage.mark += hesitation * TestPage.faults[index ~/ 2-1][0];
                                          TestPage.mark += correction * TestPage.faults[index ~/ 2-1][1];
                                          TestPage.mark += hesitationT * TestPage.faults[index ~/ 2-1][2];
                                          TestPage.mark += correctionT * TestPage.faults[index ~/ 2-1][3];
                                          TestPage.mark += taj * TestPage.faults[index ~/ 2-1][4];
                                          TestPage.faults.removeAt(index ~/ 2 -1);
                                          setState(() {});
                                        },
                                        icon: const Icon(
                                            Icons.remove_circle_outline),
