...
class _MarksBottomSheetState extends State<MarksBottomSheet> {
  ...
  final List<double> cellsWidthEdit = [60, 50, 50, 60, 40, 40, 40, 40, 40];
    ...
    return Directionality(
      ...
      child: OrientationBuilder(
        builder: (BuildContext context, Orientation orientation) => Container(
            ...
            height:(!widget.isResult)? MediaQuery.of(context).size.height * ((TestPage.notes.length +7)*0.08):
                ...
                Column(
                  children: [
                    SingleChildScrollView(
                      ...
                      child: SizedBox(
                        // height: (widget.isResult) ? (questionCount*2+2) * 10: 4*10,
                        ...
                        child: Builder(
                          builder: (context) {
                            List<Widget> children = List.generate(
                              ...
                              /*itemCount:*/ (widget.isResult || questionCount == 0) ? questionCount * 2 + 2 : 4,
                                  ...
                                  if (index == 0) {
                                    return SizedBox(
                                      height: (widget.isResult)
                                          ...
                                          : 55,
                                      child: Row(children: [
                                        SizedBox(width: widget.isResult? 5: 10,),
                                        if (!widget.isResult)
                                          const IconButton(
                                            onPressed: null,
